...
class WelcomeControllerTest {
    ...
    private MockMvc mvc;
    @Test
    void welcome() throws Exception {// not preferreable way
    ...
    void welcome2() throws Exception {
        ...
        mvc.perform(request)
                .andExpect(status().isOk())//result.MockMvcResultMatchers.status;
                .andExpect(content().string("welcome"))
                .andReturn();
// if you need you can assign it to vaariable as it is like firsat Test
    }
